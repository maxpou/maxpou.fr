...
You might wonder why I'm cleaning the store with multiple `store.modules.xxxx`? Well, I want my test
...
The `storeOverrides` parameter allows you to override a part of the store for a specific test (i.e.
