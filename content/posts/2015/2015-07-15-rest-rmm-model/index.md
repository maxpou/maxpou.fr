...
Pour réserver, il faudra pointer vers la _ressource réservation_.
...
En cas de conflit, le serveur renvoie un code 409 : conflit. Ce code signifie que la requête ne peut
