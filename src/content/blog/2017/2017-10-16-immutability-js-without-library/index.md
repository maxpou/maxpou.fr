...
There is a really nice pattern called CQRS _(Command Query Responsibility Segregation)_. The
...
Whatever we use, we always face the same problem: we need a **deep clone**. Usually theses deep
