...
description:
  I investigated Thomas Harris, an AI-generated YouTuber who uses fake crypto tutorials to scam people.
date: 2024-11-28
language: en
cover: ./cover.png
tags: ['Security', 'AI']
...
Roberts has changed his name to Thomas Harris. This post also led to the Groupe d'enquêtes
cybercriminelles, a cybercrime investigation unit of the French judicial police, contacting me._
...
- All the videos have the same storyline: "a tutorial to unlock TradingView's developer mode to
  ...
  watch the videos… I used my homemade [YoutubeMate](https://youtube-mate.com) app to get the gist
  of a few of his videos.
