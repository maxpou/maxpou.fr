---
title: Thomas Roberts - Anatomy of a Crypto Scam
slug: crypto-scam-with-ai
description:
  Thomas Roberts is a fraudulent YouTuber who uses fake crypto tutorials to spread malware. He
...
<Danger>
  ⚠️ **Attention:** The following contain pieces of malicious code. **Do not try to execute it by
  any means**.
</Danger>

## TL;DR

Thomas Robert is a fake Crypto YouTuber who bought a fake audience. He gives fake tutorials on
Youtube on “how to unlock TradingView's developer mode” to grow your portfolio by XXX %. Surprise,
it doesn't. Instead, it injects malicious code into your computer.
...
It all started with a video with Thomas Roberts, an American Youtuber with 50 videos and 162k
followers. Note that the dude is verified by YouTube. Seems legit.
...
Let's look at the script. When unintended, it's hard to spot the hack. But, correctly indented, it
looks like this:
...
## Follow up - Who are you, Mr Robert?
...
And that it's for today's investigation 🕵🏻‍♂️ I told this story to a few IT friends and none of us had
seen a scam like this before:
...
Online threats are getting more and more sophisticated. With the rise of AI tools, we are just at
the beginning.

A pressing question arises: How many more Mr. Roberts are operating online? Moreover, as AI
generation tools advance, what new tactics will these scammers employ tomorrow?
