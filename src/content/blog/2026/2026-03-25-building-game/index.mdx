...
- **Level of Details (LOD)**: the farther an object is, the lower quality it will have. In Avion,
  ...
  once. It's usually because the loop was stuck and the LOD didn't refresh at the right pace.
...
- **Occlusion culling**: It's usually the next step after implementing the frustum culling. In a
...
First of all, what makes a plane fly? Physics... it's everywhere!
